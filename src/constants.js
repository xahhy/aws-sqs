...
const ACTIONS = {
  ...
  REMOVE_MESSAGE_ACTION: emoji.emojify(`:new_moon_with_face:\t${chalk.red.bold('Remove A Message')}`),
  GET_QUEUE_ATTRIBUTES_ACTION: emoji.emojify(`:rainbow:\t${chalk.magenta.bold('Get Queue Attributes')}`),
